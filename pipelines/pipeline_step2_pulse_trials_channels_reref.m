...
% This script removes the TMS pulse artifact, removes noisy trials, removes
% noisy channels, replaces missing channels with spherical interpolation, and
% rereferences the data to the averaage of all channels.

% Noisy trials and channels indices are stored in Rejections.mat
