% ##### PIPELINE STEP 4 (SOUND ALL CHANNELS) #####
...
% scripts:
% pipeline_step3_SOUND_allchans.m
...
for cx = 1:length(condition)
    for idx = 1:length(ID)
        ...
        if strcmp(condition{cx},'FastICA') || strcmp(condition{cx},'SOUND_allchans')
