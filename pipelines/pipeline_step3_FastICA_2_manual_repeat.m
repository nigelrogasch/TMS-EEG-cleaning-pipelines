% ##### PIPELINE STEP 3 (FASTICA_2 manual repeat) #####

% This script removes components consistent with decay 
% artifacts following the TMS pulse using manual selection.

% TMS-EEG data required for this script are generated from:
% pipeline_step3_FastICA_1_repeat.m

% Author: Nigel Rogasch, University of Adelaide, 2021clear; close all; clc;

% Participant IDs
ID = {'121','123','126','127','129','137','138','139','142','143','145','146','147','148'};
ID = {'126'}; %126 2, 126 3, 129 2, 129 3
condition = {'2'};
