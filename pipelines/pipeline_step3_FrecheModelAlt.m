...
for idx = 1:length(ID)
    ...
    % TESA implementation
    EEG = pop_tesa_fitartifactmodel( EEG, 'tPulseMs', 0, 'tPulseDurationMs', 2, 'tSkipMs', 8.1, 'tSelectMs', 12, 't_fitmodel_p_ms', [0  60], 't_fitmodel_n_ms', [0  60], 't_lincomb_ms', [0  100], 'epoch_range', [-500  500] );
