...
% This script runs all of the analysis and generates figure 6 from the 
% manuscript which compares the TEP outcomes from the three pipelines after
% step 4 using the optimised Freche model.
...
saveas(fig,[pathOut,'figure6.png']);